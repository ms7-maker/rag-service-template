...
if __name__ == "__main__":
    ...
    cache.set(
        ...
        answer="Курьерская доставка по Москве стоит 350р. и бесплатно при заказе от 2500р. Срок 1-2 рабочих дня. Доставка в пункт выдачи заказов стоит 250р. и бесплатно при заказе от 2000р.",
        context=["delivery_and_peyment_clean.txt"]
    )
    
    # Получение
    result = cache.get("Сколько стоит доставка по Москве?")
